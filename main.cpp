...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "orbitalcoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.orbitalcoin.io",""};
static const string testnet_seeds[] = {"test-dnsseed.orbitalcoin.io",""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
//    db.Add(CService("195.140.214.102",33339), true);
  }
  do {
